  ...
  render(){
    ...
    if(this.state.status === "Initial"){
      ...
      return(
        ...
        <h1>Create new Participant</h1>
        {form_layout}
        <h3>The following error occured while creating a new participant:</h3>
        <ul>
        {error_layout}
        </ul>
        </>
      ...
      return(
        <>
        <h1>Participant was successfully created.</h1>
      ...
      return(
        <h1> Network Error. Unable to create Participant.</h1>
      );
    }
  }
}
